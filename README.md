About polcart-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/polcart-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4100&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/polcart-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `polcart` can be installed with `conda`:
...
```
mamba install polcart
```

It is possible to list all of the versions of `polcart` available on your platform with `conda`:
...
```
mamba search polcart --channel conda-forge
```
...
mamba repoquery search polcart --channel conda-forge

# List packages depending on `polcart`:
mamba repoquery whoneeds polcart --channel conda-forge

# List dependencies of `polcart`:
mamba repoquery depends polcart --channel conda-forge
```
